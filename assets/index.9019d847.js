...
const routes = [
  {
    path: "/",
    component: () => __vitePreload(() => import("./MainLayout.db55e1f0.js"), true ? ["assets/MainLayout.db55e1f0.js","assets/game.d00a98a9.js"] : void 0),
    children: [{ path: "", component: () => __vitePreload(() => import("./IndexPage.c54ce319.js"), true ? ["assets/IndexPage.c54ce319.js","assets/game.d00a98a9.js"] : void 0) }]
  },
  {
    path: "/:catchAll(.*)*",
    component: () => __vitePreload(() => import("./ErrorNotFound.58c41a85.js"), true ? [] : void 0)
  }
];
...
createQuasarApp(createApp, quasarUserOptions).then((app2) => {
  ...
  return Promise[method]([
    __vitePreload(() => import("./notifications.091398be.js"), true ? [] : void 0)
  ]).then((bootFiles) => {
    const boot = mapFn(bootFiles).filter((entry) => typeof entry === "function");
    start(app2, boot);
  });
});
export { unref as $, leftClick as A, addEvt as B, preventDraggable as C, prevent as D, stop as E, position as F, cleanEvt as G, History as H, withDirectives as I, hDir as J, provide as K, pageContainerKey as L, hMergeSlot as M, Notify as N, reactive as O, Platform as P, onUnmounted as Q, shallowReactive as R, useRouterLinkProps as S, Transition as T, vShow as U, QIcon as V, defineComponent as W, openBlock as X, createBlock as Y, withCtx as Z, createVNode as _, computed as a, createElementBlock as a0, Fragment as a1, renderList as a2, createTextVNode as a3, toDisplayString as a4, createCommentVNode as a5, QBtn as a6, resolveComponent as a7, createBaseVNode as a8, useRouterLink as a9, isKeyCode as aa, _export_sfc as ab, hSlot as b, createComponent as c, onBeforeUnmount as d, nextTick as e, emptyRenderFn as f, getCurrentInstance as g, h, isRuntimeSsrPreHydration as i, hUniqueSlot as j, inject as k, listenOpts as l, layoutKey as m, noop$1 as n, onMounted as o, css as p, getElement as q, ref as r, client as s, stopAndPrevent as t, getEventPath as u, vmHasRouter as v, watch as w, onDeactivated as x, vmIsDestroyed as y, createDirective as z };
