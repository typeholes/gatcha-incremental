...
const routes = [
  {
    path: "/",
    component: () => __vitePreload(() => import("./MainLayout.30c2f18d.js"), true ? ["assets/MainLayout.30c2f18d.js","assets/MainLayout.12102379.css","assets/QCard.1b919184.js"] : void 0),
    children: [{ path: "", component: () => __vitePreload(() => import("./IndexPage.7f2501ec.js"), true ? ["assets/IndexPage.7f2501ec.js","assets/QCard.1b919184.js"] : void 0) }]
  },
  {
    path: "/:catchAll(.*)*",
    component: () => __vitePreload(() => import("./ErrorNotFound.7f376dca.js"), true ? [] : void 0)
  }
];
var createRouter = route(function() {
  ...
  const Router = createRouter$1({
    ...
    routes,
    history: createHistory("/gatcha-incremental/")
  });
  return Router;
});
...
var quasarUserOptions = { config: { "dark": true, "notify": {} }, plugins: { Notify } };
const publicPath = `/gatcha-incremental/`;
...
createQuasarApp(createApp, quasarUserOptions).then((app2) => {
  ...
  return Promise[method]([
    __vitePreload(() => import("./notifications.f1fc775b.js"), true ? [] : void 0)
  ]).then((bootFiles) => {
    const boot = mapFn(bootFiles).filter((entry) => typeof entry === "function");
    start(app2, boot);
  });
});
export { QIcon as $, isRuntimeSsrPreHydration as A, noop$1 as B, emptyRenderFn as C, hUniqueSlot as D, inject as E, layoutKey as F, createDirective as G, History as H, leftClick as I, addEvt as J, preventDraggable as K, prevent as L, stop as M, Notify as N, position as O, Platform as P, cleanEvt as Q, withDirectives as R, hDir as S, Teleport as T, provide as U, pageContainerKey as V, hMergeSlot as W, reactive as X, shallowReactive as Y, useRouterLinkProps as Z, vShow as _, computed as a, defineComponent as a0, openBlock as a1, createBlock as a2, withCtx as a3, createVNode as a4, unref as a5, createElementBlock as a6, Fragment as a7, renderList as a8, createTextVNode as a9, toDisplayString as aa, createCommentVNode as ab, QBtn as ac, _export_sfc as ad, createBaseVNode as ae, pushScopeId as af, popScopeId as ag, resolveDynamicComponent as ah, resolveComponent as ai, useRouterLink as aj, hSlot as b, createComponent as c, onDeactivated as d, vmHasRouter as e, onMounted as f, getCurrentInstance as g, h, onUnmounted as i, injectProp as j, createGlobalNode as k, removeGlobalNode as l, css as m, nextTick as n, onBeforeUnmount as o, getElement as p, client as q, ref as r, listenOpts as s, stopAndPrevent as t, getEventPath as u, vmIsDestroyed as v, watch as w, isKeyCode as x, Transition as y, childHasFocus as z };
